...
export class ReservationController {
  ...
  // Route back-office pour créer une réservation avec auto-création du client
  @Roles(Role.ADMIN, Role.EVENT_MANAGER)
  @Post("back-office")
  async createBackOffice(@Body() data: any) {
    return this.reservationService.createBackOffice(data);
  }
